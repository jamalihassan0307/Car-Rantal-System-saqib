// Get cars from localStorage or use default data
...
function editCar(carId) {
    ...
    document.getElementById('editCarPrice').value = car.price.replace('$', '').replace('/day', '');
...
editCarForm.onsubmit = (e) => {
    ...
    cars[carIndex] = {
        ...
        features: document.getElementById('editCarFeatures').value.split(',').map(f => f.trim()),
